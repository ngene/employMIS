...
<head>
  ...
  <title>INTEGRATED ONLINE EMPLOYMENT INFORMATION SYSTEM</title>
...
<div class="wrapper">
  ...
  <h2 style="color: white;">INTEGRATED ONLINE EMPLOYMENT INFORMATION SYSTEM</h2>
    <!-- Logo -->
   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">CREATE INSTITUTION PROFILE</h1>
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="companyname" placeholder="Institution Name" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4" name="aboutme" placeholder="Brief info about your institution"></textarea>
              </div>
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <label>Attach Institution Logo</label>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="learningfromscratch.online">Integrated Online Employment MIS</a>.</strong> All rights
    reserved.
    </div>
  </footer>
