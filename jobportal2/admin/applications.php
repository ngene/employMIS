...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>INTEGRATED</b> ONLINE EMPLOYMENT IMS</span>
    </a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <p>Here is the module that helps the admin to manage all manner of applications that have been posted to the Management Information System... .</p>
          </div>
