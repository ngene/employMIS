...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>INTEGRATED </b> ONLINE EMPLOYMENT INFORMATION SYSTEM</span>
    </a>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="companies.php"><i class="fa fa-building"></i> INSTITUTIONS</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3>INTEGRATED ONLINE EMPLOYMENT MANAGEMENT INFORMATION SYSTEM Statistics</h3>
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">ACTIVE INSTITUTIONS Registered</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">PENDING INSTITUTION APPROVAL</span>
                    <?php
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018 <a href="learningfromscratch.online">INTEGRATED ONLINE EMPLOYMENT MANAGEMENT INFORMATION SYSTEM</a>.</strong> All rights
    reserved.
    </div>
  </footer>
