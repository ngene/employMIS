...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>INTEGRATED</b> ONLINE EMPLOYMENT MANAGEMENT INFORMATION SYSTEM</span>
    </a>
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="companies.php"><i class="fa fa-building"></i> INSITUTIONS</a></li>
