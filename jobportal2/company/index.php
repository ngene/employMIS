...
<div class="wrapper">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="edit-company.php"><i class="fa fa-tv"></i> My INSTITUTION</a></li>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018 <a href="learningfromscratch.online">INTEGRATED ONLINE EMPLOYMENT INFORMATION SYSTEM</a>.</strong> All rights
    Reserved.
    </div>
  </footer>
